...
export default function WorkerAnalytics({ params }) {
  ...
  const handleExportCSV = () => {
    const csvData = [
      ["Metric", "Value", "Unit"],
      ["Average Response Time", analyticsData.performance.avgResponseTime, "ms"],
    ...
    a.href = url
    a.download = `worker-${params.id}-analytics-${new Date().toISOString().split("T")[0]}.csv`
    a.click()
          ...
          <div className="p-6">
            ...
            <nav className="space-y-1">
              ...
              <motion.div
                ...
                transition={{ duration: 0.2 }}
              >
                <TrendingUp className="h-4 w-4 mr-3 text-slate-600" />
                Analytics
              </motion.div>
              <Link href={`/admin/worker/${params.id}/alerts`}>
                <motion.div
                  className="flex items-center px-3 py-2.5 text-sm font-medium text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors"
                  whileHover={{ scale: 1.01 }}
                  transition={{ duration: 0.2 }}
            ...
            <motion.div variants={itemVariants} className="mb-8">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div>
                  ...
                  <p className="text-slate-600 mt-2">Comprehensive performance analytics and usage statistics</p>
                </div>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <Button onClick={handleExportCSV} variant="outline" className="shadow-sm bg-transparent">
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
              ...
              <Card className="bg-white border border-slate-200/80 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    <div className="text-3xl font-bold text-slate-900">{analyticsData.performance.uptime}%</div>
              ...
              <Card className="bg-white border border-slate-200/80 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    <div className="text-3xl font-bold text-slate-900">{analyticsData.performance.throughput}</div>
                    <div className="flex items-center gap-2 text-sm">
                      <TrendingUp className="h-3 w-3 text-emerald-500" />
              ...
              <Card className="bg-white border border-slate-200/80 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    <div className="text-3xl font-bold text-slate-900">{analyticsData.performance.errorRate}%</div>
                    <Progress value={analyticsData.performance.errorRate} className="h-2" />
                  </div>
                </CardContent>
              </Card>
            </motion.div>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-4 bg-slate-50 rounded-lg">
                      <div className="text-2xl font-bold text-slate-900">{analyticsData.usage.totalSessions}</div>
                      <div className="text-sm text-slate-600">Total Sessions</div>
                    </div>
                    <div className="text-center p-4 bg-emerald-50 rounded-lg">
                      <div className="text-2xl font-bold text-emerald-600">{analyticsData.usage.activeSessions}</div>
                      <div className="text-sm text-slate-600">Active Sessions</div>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-slate-600">Session Utilization</span>
                      <span className="text-sm font-medium text-slate-900">
                        {Math.round((analyticsData.usage.activeSessions / analyticsData.usage.totalSessions) * 100)}%
                      </span>
                    </div>
                    <Progress
                      value={(analyticsData.usage.activeSessions / analyticsData.usage.totalSessions) * 100}
                      className="h-2"
                    />
                  </div>
                </CardContent>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-center p-4 bg-purple-50 rounded-lg">
                      <div className="text-2xl font-bold text-purple-600">{analyticsData.usage.dataTransferred}</div>
                      <div className="text-sm text-slate-600">Data Transferred</div>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-slate-600">Messages per Session</span>
                      <span className="text-sm font-medium text-slate-900">
                        {Math.round(analyticsData.usage.totalMessages / analyticsData.usage.totalSessions)}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-slate-600">Avg Data per Session</span>
                      <span className="text-sm font-medium text-slate-900">18.9 MB</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="h-64 flex items-center justify-center bg-slate-50 rounded-lg">
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-slate-500 text-sm">Response Time & Throughput Chart</p>
                ...
                <CardContent>
                  <div className="h-64 flex items-center justify-center bg-slate-50 rounded-lg">
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-slate-500 text-sm">Session Status Distribution</p>
                      <div className="flex justify-center gap-4 text-xs">
                        <div className="flex items-center gap-1">
                    ...
                    <table className="w-full">
                      ...
                      <tbody className="divide-y divide-slate-200">
                        <tr className="hover:bg-slate-50">
                          <td className="py-3 px-4 text-slate-900">Average Response Time</td>
                        ...
                        <tr className="hover:bg-slate-50">
                          <td className="py-3 px-4 text-slate-900">Peak Response Time</td>
