...
export default function WorkerSessions({ params }) {
  ...
  const toggleMaintenanceMode = () => {
    ...
    alert(
      `Worker maintenance mode ${!isMaintenanceMode ? "enabled" : "disabled"}`
    );
  };
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div>
            ...
            <p className="text-slate-600 mt-2">
              Manage and monitor active sessions on {workerData.name}
            </p>
          </div>
            ...
            >
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Select target worker to migrate selected sessions
                  </DialogDescription>
                </DialogHeader>
                ...
                <DialogFooter>
                  ...
                  <Button
                    onClick={() =>
                      handleMigrateSession("selected", "worker-02")
                    }
                  >
                    Migrate Sessions
                  </Button>
                      ...
                      <TableCell className="py-4 text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem
                              onClick={() =>
                                handleMigrateSession(session.id, "worker-02")
                              }
                            >
